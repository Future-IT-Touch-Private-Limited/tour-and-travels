<%@ Page Title="View/Edit Vehicle" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="view-vehicle.aspx.cs" Inherits="admin_view_vehicle" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active">View/Edit Vehicle</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade profile-overview active show" role="tabpanel">
                                ...
                                <div class="row pb-3">
                                    <div class="col-lg-4 col-md-4">Regd. No.</div>
                                    <div class="col-lg-8 col-md-8">
                                        <asp:TextBox ID="regd_number" ReadOnly="true" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row pb-3">
                                ...
                                <div class="row pb-3">
                                    <div class="col-lg-12 text-center">
                                        <asp:Button ID="update_btn" OnClick="update_btn_Click" CssClass="btn btn-md btn-primary" runat="server" Text="Update Vehicle Details" />
                                    </div>
                                </div>
                            </div>
                        </div>
