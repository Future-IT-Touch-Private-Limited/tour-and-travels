<%@ Page Title="Add Review" Language="C#" MasterPageFile="~/main-admin.master" AutoEventWireup="true" CodeFile="add-review.aspx.cs" Inherits="admin_add_review" %>
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade profile-overview active show" role="tabpanel">
                                ...
                                <div class="row pb-3">
                                    <div class="col-lg-4 col-md-4">Review</div>
                                    <div class="col-lg-8 col-md-8">
                                        <asp:TextBox ID="review" TextMode="MultiLine" Rows="10" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row pb-3">
                                    <div class="col-lg-4 col-md-4">Review By</div>
                                    <div class="col-lg-8 col-md-8">
                                        <asp:TextBox ID="review_by" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row pb-3">
                                    <div class="col-lg-4 col-md-4">Designation</div>
                                    <div class="col-lg-8 col-md-8">
                                        <asp:TextBox ID="designation" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row pb-3">
                                    <div class="col-lg-4 col-md-4">Review Star</div>
                                    <div class="col-lg-8 col-md-8">
                                        <asp:DropDownList ID="review_star" runat="server" CssClass="form-control">
                                ...
                                <div class="row pb-3">
                                    <div class="col-lg-12 text-center">
                                        <asp:Button ID="add_btn" OnClick="add_btn_Click" CssClass="btn btn-md btn-primary" runat="server" Text="Add Review" />
                                    </div>
                                </div>
                            </div>
                        </div>
