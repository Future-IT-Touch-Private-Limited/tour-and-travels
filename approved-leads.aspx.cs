...
public partial class admin_approved_leads : System.Web.UI.Page
{
    ...
    DataTable GetData()
    {
        ...
        string strcon = "select * from leads where status='Approved' ORDER BY sr DESC";
    ...
    public void all_count()
    {
        try
        {
            ...
            string myScalarQuery01 = "select count(*) from leads where status='Approved'";
